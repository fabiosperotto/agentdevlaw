...
public class NewLawExample {
	...
	public static void main(String[] args) {
		...
		Norm newNorm = new Norm("8899-_article-2", "pay-a-fine_200-300", "PayAFine");
		newNorm.setRole("miner"); //optional, if empty allRoles is the default

		norms.add(newNorm); //more than one can be created:
		
		newNorm = new Norm("8899-_article-2", "equipment-loss", "Seizure");
		newNorm.setRole("miner");
		norms.add(newNorm);
